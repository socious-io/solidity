...
contract PaymentEscrow is Ownable {
    ...
    function _setSellerFee(uint _newFee) private {
        require (_newFee != getProviderFee());
        _providerFee = _newFee;
    }

    function setSellerFee(uint newFee) public onlyOwner {
        _setSellerFee(newFee);
    }

    function _setBuyerFee(uint _newFee) private {
        require (_newFee != getOrgFee());
        _orgFee = _newFee;
    }

    function setBuyerFee(uint newFee) public onlyOwner {
        _setBuyerFee(newFee);
    }
